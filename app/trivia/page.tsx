...
import CategoriesTab from "@/app/components/CategoriesTab";
import SetupTab from "@/app/components/SetupTab";
import FavoritesTab from "@/app/components/FavoritesTab";
import PlayerStatsTab from "@/app/components/PlayerStatsTab";
import ThemeSettingsTab from "@/app/components/ThemeSettingsTab";
import SoundSettingsTab from "@/app/components/SoundSettingsTab";
import KeyboardShortcutsTab from "@/app/components/KeyboardShortcutsTab";
import ChatBoardBuilder from "@/app/components/ChatBoardBuilder";
import DraftCategoriesTab from "@/app/components/DraftCategoriesTab";
import UserHeader from "@/app/components/auth/UserHeader";
import MigrationBanner from "@/app/components/migration/MigrationBanner";
...
const TABS: { id: Tab; label: string }[] = [
  ...
  { id: "drafts",     label: "\u{1F4CB} Drafts" },
    ...
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center py-8 px-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/live"
            className="px-4 py-2 rounded-lg font-medium text-sm bg-[#060CE9] hover:bg-[#0510ff] text-white transition-all flex items-center gap-2 shadow-sm"
          >
            Live Mode
          </Link>
          <button
      ...
      {soundToast && (
        ...
        >
          <span className="text-xl">{soundEnabled ? "\u{1F50A}" : "\u{1F507}"}</span>
